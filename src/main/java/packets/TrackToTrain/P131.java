...
public class P131 extends Packet {
    ...
    public P131() {
        this(new String[]{ArithmeticalFunctions.hex2Bin("8301020D027004CE0041512800502FFF0")});
    }

    public P131(String[] d) {
        ...
        this.d_rbctr = (D_RBCTR) new D_RBCTR().initValueSet(d);
    ...
    public Component getPacketComponent() {
        ...
        jPanel.add(d_rbctr.getComponent());
    ...
    public String getSimpleView() {
        ...
        tmp += q_scale.getSimpleView();
        tmp += d_rbctr.getSimpleView();
        tmp += nid_c.getSimpleView();
        tmp += nid_rbc.getSimpleView();
        tmp += nid_radio.getSimpleView();
        tmp += q_sleepsession.getSimpleView();
    ...
    public String getBinData() {
        ...
        l_packet.setBinValue(ArithmeticalFunctions.dec2XBin(String.valueOf(tmp.length()), 13));
        tmp = "";
        tmp = getBinDataPrivately(tmp);
    ...
    @Override
    public Component getGraphicalVisualization() {return null;
    }
