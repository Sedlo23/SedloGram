...
public class P145 extends Packet {

    private static final Logger LOG = LogManager.getLogger(P145.class);
    ...
    public P145() {
        this(new String[]{ArithmeticalFunctions.hex2Bin("91802E")});
    }

    public P145(String[] d) {
